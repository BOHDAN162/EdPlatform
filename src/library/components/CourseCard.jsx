...
const CourseCard = ({ course, statusLabel }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between text-xs muted-text gap-3">
      ...
      <div>
        ...
        <p className="text-sm muted-text mt-1 line-clamp-2">{course.description}</p>
      </div>
      {progress > 0 && (
      ...
      <div className="flex items-center justify-between text-sm muted-text mt-auto">
